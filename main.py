...
para_orig, costs_orig = model.l_layer_model(train_X, train_Y, layers_dims, num_iterations=30000, learning_rate=0.3, grad_check=True)
...
para_re, costs_re = model.l_layer_model_with_re(train_X, train_Y, layers_dims, num_iterations=30000, learning_rate=0.3, lambd=0.7,
                                      grad_check=True)
...
para_drop, costs_drop = model.l_layer_model_dropout(train_X, train_Y, layers_dims, num_iterations=30000, learning_rate=0.3,
                                        keep_prob=0.8)
